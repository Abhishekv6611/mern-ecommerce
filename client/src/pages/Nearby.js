...
const TopRated = () => {
  return (
    <section id="toprated" className="p-5"> 
              <h1 className="text-3xl font-playfair font-bold px-3 flex items-center gap-2 mb-3"><Link to={'/'}><p className="border rounded p-1 hover:bg-black hover:text-white  transition"><MdArrowBackIosNew /></p></Link>Near By</h1>
        ...
        <div className="w-full md:w-1/2 flex flex-col  md:pl-10">
          <h1 className=" md:text-left text-black font-bold text-3xl md:text-5xl mb-5 md:mb-11">Hotel Machester</h1>
